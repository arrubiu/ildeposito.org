...
drush en entityreference_migration paragraphs ildeposito_utils ildeposito_libreria imagecache_token ildepositoboot ildeposito_autore ildeposito_customcontent ildeposito_canto ildeposito_articolo ildeposito_evento ildeposito_pagina ildeposito_traduzione -y
drush emr
...
## Moduli custom
drush dis -y ildeposito_purge, stampa, ildeposito_news, ildeposito_social, ildeposito_cron, alterator, elenchi, ildeposito_app, ildeposito_ct_libreria, ildeposito_ct_canto, ildeposito_ct_customcontent, ildeposito_ct_autore, ildeposito_ct_articolo, ildeposito_ct_evento, ildeposito_ct_fonte, ildeposito_ct_pagina, ildeposito_ct_traduzione
#@TODO: aggiungiugere uninstall per tutti i moduli custom disabilitati quando finito
