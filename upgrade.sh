...
drush en entityreference_migration paragraphs ildeposito_utils ildeposito_libreria imagecache_token ildepositoboot -y
drush emr
...
## Moduli custom
drush dis -y ildeposito_purge, stampa, ildeposito_news, ildeposito_social, ildeposito_cron, alterator, elenchi, ildeposito_app, ildeposito_ct_libreria
drush pm-uninstall -y ildeposito_purge, stampa, ildeposito_news, ildeposito_social, ildeposito_cron, alterator, elenchi, ildeposito_app, ildeposito_ct_libreria
